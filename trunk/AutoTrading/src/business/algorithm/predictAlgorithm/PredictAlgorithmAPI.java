...
public class PredictAlgorithmAPI {
	...
	public static final String[] PREDICTION_ALGORITHM_LIST = {
		AUTOREGRESSION, AUTOREGRESSION_MA, AUTOREGRESSION_FE, PARTICLE_FILTER, ARFE_PF, LAGRANGE_EXTRAPOLATION, LAGRANGE_MA, LAGRANGE_FE, BARYCENTRIC_EXTRAPOLATION, BARYCENTRIC_MA, BARYCENTRIC_FE };
