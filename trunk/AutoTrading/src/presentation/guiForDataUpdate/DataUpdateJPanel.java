...
public class DataUpdateJPanel extends javax.swing.JPanel {
                        ...
                        .addGroup(updateJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(updateJPanelLayout.createSequentialGroup()
                                .addGroup(updateJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(sourceJComboBox, 0, 340, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void updateJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateJButtonActionPerformed
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                updatedExchangeEntity = exchangeManager.getExchangeByName((String) exchangeUpdateJComboBox.getSelectedItem());
                ...
                TimerTask task1 = new TimerTask() {
                    ...
                    @Override
                    public void run() {
                        updateStatusjLabel.setText("Last updated date is: " + priceManager.getLatestDateOfExchange(updatedExchangeEntity.getExchangeID()));
                    }
                };
                ...
                TimerTask task2 = new TimerTask() {
                    ...
                    @Override
                    public void run() {
                        updateStatusjLabel.setText("Updating ...");
                    }
                };

                timer.schedule(task2, 0, 15000);
                timer.schedule(task1, 5000, 15000);

                dataUpdate.updateDataFromDateToDate(updatedExchangeEntity, fromDate, toDate);
    ...
    private void updateDataStatus() {
        ...
        dataStatusJLabel.setText(dataStatus.get((ExchangeEntity) exchangeJComboBox.getSelectedItem()));
    }
...
//    private File selectedFile = null;
    ...
    private Date toDate;
    private ExchangeEntity updatedExchangeEntity;
